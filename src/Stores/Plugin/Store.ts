import {StoreManager} from 'vue-class-stores';
...
export abstract class Store<T extends object> {
	 ...
	 */
	private _setup() {
		this.state = observable(this._getInitialState()) as UnwrapNestedRefs<UnwrapRef<T>>;
	 ...
	 * @returns {boolean}
	 */
	private _hasWatcher(property: string): boolean {
